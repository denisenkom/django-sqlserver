...
class SelectForUpdateTests(TransactionTestCase):
    ...
    available_apps = ['mssql_select_for_update']
    ...
    def test_for_update_sql_generated(self):
        ...
        generated SQL when mssql_select_for_update is invoked.
        """
    ...
    def run_select_for_update(self, status, nowait=False):
        ...
        Person instances. After the mssql_select_for_update, it attempts
    ...
    def test_block(self):
        """
        Check that a thread running a mssql_select_for_update that
        ...
        # Now, try it again using the ORM's mssql_select_for_update
    ...
    def test_transaction_dirty_managed(self):
        """ Check that a mssql_select_for_update sets the transaction to be
